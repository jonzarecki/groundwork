...
# bob@partner.com: 1x 1:1 email_sent (3pt) + has_direct_bonus (5pt) + external_direct_bonus (10pt) = 18 points
# bob is external (partner.com != test home domain example.com in CI)
BOB_SCORE=$(sql "SELECT interaction_score FROM people WHERE email = 'bob@partner.com';")
assert_eq "bob score = 18 (1:1 email_sent 3pt + direct_bonus 5pt + external_bonus 10pt)" "18" "$BOB_SCORE"
