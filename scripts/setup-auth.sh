...
if [ ! -f "$CORE_SCRIPT" ]; then
    ...
    echo "Expected local-automation-mcp to be a sibling directory of groundwork."
    exit 1
fi

# For groundwork, write Slack/Google creds to the project .env
# (the Docker stack uses mcp-secrets.env, but groundwork's
